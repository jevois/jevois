...
if (EXISTS "/usr/lib/x86_64-linux-gnu/libboost_python312.so")
  ...
  set(JEVOIS_PLATFORM_CXX_STD "c++26")
...
elseif (EXISTS "/usr/lib/x86_64-linux-gnu/libboost_python38.so")
  ...
  set(JEVOIS_PLATFORM_CXX_STD "c++20")
  set(JEVOIS_HOST_PYTHON_MAJOR 3)
...
########################################################################################################################
# Include path:
set(JEVOIS_PLATFORM_INCLUDE "-I${JEVOIS_BUILD_BASE}/usr/local/include -I${JEVOIS_BUILD_BASE}/usr/include ${JEVOIS_PLATFORM_OPENCV_INCLUDE} ${JEVOIS_PLATFORM_KERNEL_INCLUDE} ${JEVOIS_PLATFORM_TBB_INCLUDE} ${JEVOIS_PLATFORM_PYTHON_INCLUDE} -I/var/lib/${JEVOIS}-microsd/include")

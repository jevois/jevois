...
if ($ispython)
{
    # For python let's just find member functions named 'process' and count the argsL
    foreach my $m (@methods)
    {
        ...
        if ($hash{'kind'} eq 'function' && $hash{'name'} eq 'process')
        {
            ...
            elsif ($#methodparams == 2) { $process2 = 1; } # 3 args: self, inframe, outframe
        }
    }
}
else
...
print OF "<tr><td class=videomapping><small><font color=navy>\n";
print OF "<b>&nbsp;Language: &nbsp; </b>";
if ($ispython) { print OF "Python"; } else { print OF "C++"; }
print OF "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
print OF "<b>Supports mappings with USB output: &nbsp; </b>";

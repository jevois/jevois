...
//#define IM_STRINGIFY(x) #x
//#define IM_TOSTRING(x) IM_STRINGIFY(x)
//#define IM_ASSERT(_EXPR) do { if (!(_EXPR)) { LFATAL("ImGui assersion failed: "<<IM_TOSTRING(_EXPR)); } } while (false)

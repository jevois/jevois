...
// ######################################################################
// ######################################################################
jevois::ParameterCategory::ParameterCategory(std::string const & name_, std::string const & description_) :
...
// ######################################################################
// ######################################################################
jevois::ParameterDefBase::ParameterDefBase(std::string const & name, std::string const & description,
                                           ParameterCategory const & category) :
    itsName(name), itsDescription(description), itsCategory(category)
{ }
